...
//import AdminNav from "../../components/AdminNav"; // No longer needed
...
const AdminLenderUsers = () => {
    ...
    useEffect(() => {
        ...
        const fetchLenderUsers = async () => {
            setLoading(true);
            try {
                // CORRECTED URL (Hardcoded, for now)
    ...
    const handleApprove = async (id) => { //keep handle approve here.
    ...
    return (
      ...
      <div style={{ padding: "20px" }}>
          ...
          {/* Single Table for All Lender Users */}
